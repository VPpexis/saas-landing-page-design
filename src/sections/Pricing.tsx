  ...
  return (
    <section className="bg-white py-24">
      <div className="container">
        ...
        <p className=" section-heading section-description mt-5"> 
          Free forever. Upgrade for unlimited tasks, better security, and exlusive initegration.
        </p>
        <div className='flex flex-col gap-6 items-center mt-10 lg:flex-row lg:items-end lg:justify-center'>
          {
            ...
            <div key={title} className={twMerge('p-10 border border-[#F1F1F1] rounded-3xl shadow-[0_7px_14px_#EAEAEA] max-w-xs w-full',
